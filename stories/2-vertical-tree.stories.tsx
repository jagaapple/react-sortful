...
import styles from "./2-vertical-tree.stories.css";
...
storiesOf("2 Vertical Tree", module)
  .add("Static", () => {
    const renderGhostElement = React.useCallback(({ isGroup }: GhostRendererMeta<DummyItem["id"]>) => {
    ...
    const [itemEntitiesMapState, setItemEntitiesMapState] = React.useState(
      (): Map<DummyItem["id"], NormalizedDummyItem> =>
        new Map([
          ...
          [
            "23e03875-675e-45a7-b62a-3d444269ccdf",
            { id: "23e03875-675e-45a7-b62a-3d444269ccdf", title: "Library", children: [] },
          ],
          [
            "7eebbba8-c485-42b4-9df9-2057caddce6d",
            { id: "7eebbba8-c485-42b4-9df9-2057caddce6d", title: "System", children: [] },
          ],
          [
            "5178aae3-0eab-459d-a921-d3d02e95760e",
            {
          ...
          [
            "868eb97c-7970-45e5-bec1-8eb626d7b0b9",
            { id: "868eb97c-7970-45e5-bec1-8eb626d7b0b9", title: "Documents", children: [] },
          ],
          [
            "258be242-8493-4cb5-bf9e-35778aa3ad69",
            {
          ...
          [
            "7a16103d-13e5-4269-a4ac-87f630484a5f",
            { id: "7a16103d-13e5-4269-a4ac-87f630484a5f", title: "pages", children: [] },
          ],
          [
          ...
          [
            "37e73dcc-53b1-423a-9574-c78942c60a0f",
            { id: "37e73dcc-53b1-423a-9574-c78942c60a0f", title: "Network", children: [] },
          ],
        ]),
    );
